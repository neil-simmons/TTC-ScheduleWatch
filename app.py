...
st.caption("Open-data analysis tool of TTC streetcar performance versus published schedules (GTFS). Visualizes streetcar trips between March 15 - May 2 2026. This website is not affiliated with the TTC. Source: https://github.com/neil-simmons/TTC-ScheduleWatch/tree/main  \nAll results are **estimates**. This tool can help identify where, when and the nature of schedule deviation and delay present in streetcar routes, suggesting optimized schedules. Made by Neil Simmons (linkedin.com/in/n-simmons).")
